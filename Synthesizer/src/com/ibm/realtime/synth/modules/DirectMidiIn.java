...
public class DirectMidiIn implements Runnable, MidiIn {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.realtime.synth.engine.MidiIn#close()
	 */
	public void close() {
		stopRequested = true;
		synchronized (this) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.realtime.synth.engine.MidiIn#getDeviceIndex()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.realtime.synth.engine.MidiIn#addListener(com.ibm.realtime.synth.engine.MidiIn.Listener)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.realtime.synth.engine.MidiIn#removeListener(com.ibm.realtime.synth.engine.MidiIn.Listener)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.realtime.synth.engine.MidiIn#isOpen()
	 */
